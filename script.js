    ...
    updateLocalData(type, remoteData) {
        ...
        try {
            ...
            remoteUsers.forEach(remoteUser => {
                ...
                // ✅ إذا كان المحلي يحتوي على passwordHash والبعيد لا يحتوي → احتفظ بالمحلي
                if (localUser && localUser.passwordHash && !remoteUser.passwordHash) {
                    ...
                    processedUsers.push(localUser); // احتفظ بالمحلي كما هو
                } else {
                    processedUsers.push({
                        ...remoteUser,
            ...
            // إضافة المستخدمين المحليين فقط (الجدد)
