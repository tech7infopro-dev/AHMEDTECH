...
const envVars = {
  ...
  'NEXT_PUBLIC_DEFAULT_OWNER_USERNAME': process.env.NEXT_PUBLIC_DEFAULT_OWNER_USERNAME || 'TECHPRO',
  'NEXT_PUBLIC_DEFAULT_OWNER_NAME': process.env.NEXT_PUBLIC_DEFAULT_OWNER_NAME || 'AHMEDTECH',
