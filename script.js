...
function confirmDeleteTicket() {
    ...
    const result = ticketManager.deleteTicket(ticketToDelete);
...
document.getElementById('deleteMacModalConfirm').addEventListener('click', function() {
    const macId = parseInt(document.getElementById('deleteMacModal').dataset.macId);

    const result = macManager.deleteMAC(macId);
...
document.getElementById('deleteXtreamModalConfirm').addEventListener('click', function() {
    const xtreamId = parseInt(document.getElementById('deleteXtreamModal').dataset.xtreamId);

    const result = xtreamManager.deleteXtream(xtreamId);
...
document.getElementById('deleteAppModalConfirm').addEventListener('click', function() {
    confirmDeleteApp();
});
...
async function syncFromFirebase() {
  ...
  try {
    ...
    if (xtreamsResult.success) {
      const firebaseXtreams = xtreamssResult.xtreams.map(x => ({...x, id: parseInt(x.id)}));
